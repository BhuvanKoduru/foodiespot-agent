 ...
 **DO NOT ASSUME MISSING DETAILS FOR A TOOL CALL. PROMPT THE USER TO GIVE THE MISSING DETAILS**
...
find_alternate_restaurants_tool = {
    'type': 'function',
    'function': {
...
def chat_with_llama():
    ...
    response:ChatResponse = chat(
        ...
        # tools=[get_location_tool,confirm_reservation_tool, find_alternate_restaurants_tool]
    )
    ...
    if response.message.tool_calls:
        ...
        final_response = chat('llama3.1', messages=st.session_state['messages'])
